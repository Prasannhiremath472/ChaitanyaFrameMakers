    ...
    <>
      ...
      <div style={{ background: '#fff', minHeight: '100vh' }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, #8B0000 0%, #CC0000 100%)' }} className="py-14 px-6 text-center">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-bold text-white mb-2">Privacy Policy</h1>
          <p className="text-sm" style={{ color: 'rgba(255,255,255,0.7)' }}>Last updated: January 1, 2026</p>
        </div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            ...
            {[
              ...
              { title: '3. Information Sharing',
                body: 'We do not sell, trade or rent your personal information to third parties. We may share information with trusted partners who assist us in operating our website and conducting business, as long as they agree to keep this information confidential.' },
              ...
              { title: '8. Contact Us',
                body: 'For privacy-related questions, contact us at privacy@chaitanyaframes.com or write to us at our registered address in Pune, Maharashtra, India.' },
            ].map((s, i) => (
              <motion.div key={s.title}
                initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }} transition={{ delay: i * 0.05 }}>
                <h2 className="font-display text-xl font-bold mb-3" style={{ color: '#1a0000' }}>{s.title}</h2>
